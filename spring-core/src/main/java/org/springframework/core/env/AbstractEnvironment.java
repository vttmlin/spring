...
public abstract class AbstractEnvironment implements ConfigurableEnvironment {
	...
	/**
	 * 调用来自 {@link org.springframework.context.support.AbstractRefreshableConfigApplicationContext#resolvePath(java.lang.String)}
	 * 			<code>return environment.resolveRequiredPlaceholders(path);</code> 参数目前还是 路径
	 * */
	@Override
	public String resolveRequiredPlaceholders(String text) throws IllegalArgumentException {
		/**
		 * 这个变量 propertyResolver 是在类加载的时候 产生的 final 修饰 对象持有同一接口的其他对象 就比如领导。。。
		 * 实际执行的方法 {@link AbstractPropertyResolver#resolveRequiredPlaceholders(java.lang.String)}
		 * */
